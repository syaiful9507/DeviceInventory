        ...
        <div class="span9" id="content">
            <div class="row-fluid">
                <a href="add_Device.php" class="btn btn-info" id="add" data-placement="right"
                   title="klik untuk menambah"><i class="icon-plus-sign icon-large"></i> Tambah barang</a>
                ...
                <div id="" class="block">
                    ...
                    <div class="block-content collapse in">
                        ...
                        if (isset($_POST['update'])) {
                            ...
                            mysql_query("insert into notification (fullname,notification,date_of_notification,link) value('$client_fullname','Edit Barang $dev_name, Kode  barang: $dev_serial',NOW(),'device_stocks.php')") or die(mysql_error());
                            ?>
                            <script>
                                window.location = "device_stocks.php";
                                $.jGrowl("Barang sukses diupdate", {header: 'Device update'});
                            </script>
                            <?php
                        }
