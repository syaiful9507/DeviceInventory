...
<div class="modal-body">
    <form class="form-horizontal" method="post" action="advance_search.php">
			  ...
			  <div class="controls">
			  <input type="text" name="stdev_location_name" id="inputEmail" placeholder="lokasi" >
			  </div>
			  </div>
			  ...
			  <div class="controls">
			  <input type="text" name="dev_name" id="inputEmail" placeholder="jenis" >
			  </div>
			  </div>
			   ...
			   <div class="controls">
			   <input type="text" name="dev_serial" id="inputPassword" placeholder="kode">
			   </div>
			   </div>	
