					   ...
					   <div class="offset2">
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><i class="icon-user"></i>&nbsp;Ubah password staff</div>
								...
								?>		
								    ...
								    <form  method="post" id="change_password" class="form-horizontal">
										<div class="control-group">
											<label class="control-label" for="inputEmail">Password lamaC</label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword">Ulang password baru</label>
											<div class="controls">
											<input type="password" id="retype_password" name="retype_password" placeholder="Ulang password baru">
											</div>
										</div>
										<div class="control-group">
											<div class="controls">
   ...
   <script>
			...
			jQuery("#change_password").submit(function(e){
					e.preventDefault();
						...
						{
						$.jGrowl("Password tidak sama dengan password lama  ", { header: 'Change Password Failed' });
						}else if  (new_password != retype_password){
						$.jGrowl("Password tidak sama dengan password baru  ", { header: 'Change Password Failed' });
					...
					$.ajax({
						...
						$.jGrowl("Password sukses diubah", { header: 'Change Password Success' });
						var delay = 2000;
