 ...
 <div class="container-fluid">
   ...
   <div class="empty">
	   <div class="pull-right">
	     <a href="print_all_stock.php" class="btn btn-info" id="print" data-placement="top" title="klik untuk print"><i class="icon-print icon-large"></i> Print List</a>
        ...
        <a href="add_Device.php" class="btn btn-info"  id="add" data-placement="top" title="klik untuk menambah barang" ><i class="icon-plus-sign icon-large"></i> Tambah Barang</a>
		<script type="text/javascript">
		  $(document).ready(function(){
		  $('#add').tooltip('show');
		  $('#add').tooltip('hide');
