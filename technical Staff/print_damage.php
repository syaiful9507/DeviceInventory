        ...
        <div class="row-fluid">
            <div class="col-lg-12">
                <div class="alert alert-danger alert-dismissable">
                    ...
                    <i class="icon-remove"></i><strong>Laporan barang rusak/damage</strong>
                </div>
            </div>
        </div>
    </div>
...
"Times New Roman","serif"'>Stock Barang Rusak/Damage :<o:p></o:p></span></p>
...
"Times New Roman","serif"'>DATE: <?php
		   ...
		   <a href="#" onclick="window.print()" class="btn btn-info" id="print" data-placement="top"
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
			<a id="return" data-placement="top" class="btn btn-success" title="Click to Return" href="damage.php"><i
...
"Times New Roman","serif"'><o:p>&nbsp;</o:p></span></p>
 ...
 mso-yfti-tbllook:1184;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
  ...
  "Times New Roman","serif"'><o:p>&nbsp;</o:p></span></p>
                                        ...
                                        $count_item = mysql_query("select * from stdevice 
				 LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				 where dev_status = 'damage/Rusak' ORDER BY stdevice.id DESC ");
                                        $count = mysql_num_rows($count_item);
                                        ?>
  ...
  "Times New Roman","serif"'><o:p>&nbsp;</o:p></span></p>
			   ...
			   ORDER BY stdevice.id DESC");
                                    ...
                                    $count_item = mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'damage/Rusak' and dev_name = 'Alat Berat'
			   ORDER BY stdevice.id DESC");
                                    $count = mysql_num_rows($count_item);
                                    ?>
