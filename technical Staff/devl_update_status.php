									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									  ...
									  <div id="hide">
										...
										value('$client_fullname','Update Status $dev_name, Kode barang:&nbsp;&nbsp;$dev_serial' ,NOW(), 'damage.php')")or die(mysql_error());
										?>
										<script>
										window.location = "mydevice.php<?php echo '?stdev_id='.$stdev_id; ?>"; 
										$.jGrowl("Status Barang Sukses diupdate", { header: 'Device Status Update' });
										</script>
										<?php
										}
