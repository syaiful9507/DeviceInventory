        ...
        <div class="span9" id="content">
            <div class="row-fluid">
                ...
                <div id="block_bg" class="block">
                    <div class="navbar navbar-inner block-header">
                        ...
                        <div class="muted pull-right">
                            Total Barang Baru: <span class="badge badge-info"><?php echo $count; ?></span>
                        </div>
                    </div>
	          ...
	          ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="newheavy_equipment.php">Alat Berat&nbsp;<span
			   ...
			   ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="newtransport_equipment.php">Alat Angkutan&nbsp;<span
                                                    class="label label-default"> <?php echo $count; ?></span></a>
                                    </li>
			   ...
			   ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="newWorkshopTool.php">Alat Bengkel dan Alat Ukur<span
                                                    class="label label-default"> <?php echo $count; ?></span></a>
                                    </li>
	          ...
	          (select * from location_details where stdevice.id = location_details.id)	   
			   ...
			   ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="newOfficeTool.php">Alat Kantor dan Rumah Tangga&nbsp;<span
                                                    class="label label-default"> <?php echo $count; ?></span></a>
                                    </li>
			   ...
			   ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="newStudioTool.php">Alat Studio dan Komunikasi<span
                                                    class="label label-default"> <?php echo $count; ?></span></a>
                                    </li>
			   ...
			   ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="newBuilding.php">Gedung dan Bangunan<span
                                                    class="label label-default"> <?php echo $count; ?></span></a>
                                    </li>
			   ...
			   ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="newInstallation.php">INSTALASI&nbsp;<span
                                                    class="label label-default"> <?php echo $count; ?></span></a>
                                    </li>
                        ...
                        <div class="span12">
                            ...
                            <form id="send" method="post">
                                <div class="empty">
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <button class="btn btn-primary" id="snd" data-placement="right"
                                                    title="klik untuk untuk mengatur"><i class="icon-share"> Atur lokasi</i>
                                            </button>
                                            ...
                                            <div class="pull-right">
                                                <a href="print_new.php" class="btn btn-info" id="print"
                                                   data-placement="left" title="klik untuk print"><i
                                                            class="icon-print icon-large"></i> Print List</a>
                                                <script type="text/javascript">
                                                    $(document).ready(function () {
                                                        $('#print').tooltip('show');
                                                        $('#print').tooltip('hide');
                                        ...
                                        <tr>
                                            <td width="30" class="empty">
                                                <input id="" class="uniform_on" name="selector[]" type="checkbox"
                                                       value="<?php echo $id; ?>&nbspName&nbsp<?php echo $dev_name; ?>">
                                            </td>
                                            ...
                                            <td>
                                                <div class="alert alert-success"><i
                                                            class="icon-check"></i><strong><?php echo $row['dev_status']; ?></strong>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        e.preventDefault();
                                        {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (html) {
                                                    ...
                                                    $.jGrowl("Barang berhasil diatur", {header: 'Device Assign'});
                                                    var delay = 500;
                                                    setTimeout(function () {
                                                        window.location = 'device_location.php'
                                                    }, delay);
