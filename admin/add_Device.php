            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    ...
                    <div class="block-content collapse in">
                        <div class="alert alert-success"><i class="icon-info-sign"></i> Isilah data - data dibawah ini
                        </div>
                        ...
                        if (isset($_POST['save'])) {
                            ...
                            //if ($count >= 0) {
                               //<script>
                                    //alert('Maaf .! Kode Barang sudah ada);
                            ...
                            mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Menambahkan barang dengan id $dev_id')") or die(mysql_error());
                            ?>
                                <script>
                                    window.location = "device_stocks.php";
                                    $.jGrowl("Barang sukses di tambahkan", {header: 'Device add'});
                                </script>
                                <?php
