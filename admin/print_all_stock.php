...
font-family:"Times New Roman","serif"'><img width=400 height=130 id="Picture 1"
...
"Times New Roman","serif"'>Semua stok<o:p></o:p></span></p>
...
"Times New Roman","serif"'><o:p>&nbsp;</o:p></span></p>
 ...
 mso-yfti-tbllook:1184;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
  ...
  "Times New Roman","serif"'><o:p>&nbsp;</o:p></span></p>
                                        ...
                                        $count_item = mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_name = 'Alat Bengkel dan Alat Ukur' 
			   ORDER BY stdevice.id DESC");
                                        $count = mysql_num_rows($count_item);
                                        ?>
                                        <tr style='mso-yfti-irow:4;mso-yfti-lastrow:yes'>
  ...
  "Times New Roman","serif"'><?php echo $count; ?>
                                            ...
                                            $new = mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Damage/Rusak'") or die(mysql_error());
                                            $count = mysql_num_rows($new);
                                            ?>
  ...
  "Times New Roman","serif"'><o:p>&nbsp;</o:p></span></p>
                                        ...
                                        $count_item = mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_name = 'Alat Studio dan Komunikasi'
			   ORDER BY stdevice.id DESC");
                                        $count = mysql_num_rows($count_item);
                                        ?>
                                        <tr style='mso-yfti-irow:4;mso-yfti-lastrow:yes'>
  ...
  "Times New Roman","serif"'><?php echo $count; ?>
                                        ...
                                        $count_item = mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_name = 'Gedung dan Bangunan'
			    ORDER BY stdevice.id DESC");
                                        $count = mysql_num_rows($count_item);
                                        ?>
                                        <tr style='mso-yfti-irow:4;mso-yfti-lastrow:yes'>
...
<div class="empty">
    <center>
        <hr>
        <footer>
            <p>All Right Reserved T.I Powered by AKNS 2017</p>
            <footer>
    </center>
</div>
</html>