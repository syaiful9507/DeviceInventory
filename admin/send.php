<?php
	...
	mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Mengatur Barang dengan id $id[$i] ke lokasi dengan id $stdev_id')")or die(mysql_error());
    }
    header("location: device_location.php");
    }  
?>
