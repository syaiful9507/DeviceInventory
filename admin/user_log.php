                ...
                <div id="block_bg" class="block">
                    <div class="navbar navbar-inner block-header">
                        ...
                        <div class="muted pull-right">
                            Total System User Log: <span class="badge badge-info"><?php echo $count; ?></span>
                        </div>
                    </div>
                        ...
                        <div class="span12">
                            <form action="delete_user_log.php" method="post">
                                <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                    <a data-placement="right" title="Klik disini untuk menghapus yang ditandai"
                                       data-toggle="modal"
                                       href="#delete_user_log" id="delete" class="btn btn-danger" name=""><i
