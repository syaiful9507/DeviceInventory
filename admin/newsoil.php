        ...
        <div class="span9" id="content">
            <div class="row-fluid">
                ...
                <div id="block_bg" class="block">
                    <div class="navbar navbar-inner block-header">
                        ...
                        <div class="muted pull-right">
                            Total baru: <span class="badge badge-info"><?php echo $count; ?></span>
                        </div>
                    </div>

                    <h4 id="sc">Daftar aset Tanah baru
			   ...
			   ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="active">
                                        <a href="newKeyboard.php">Tanah<span
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <button class="btn btn-primary" id="snd" data-placement="right"
                                                    title="Click untuk mengirim"><i class="icon-share"> Atur ke
                                                    Lokasi</i></button>
