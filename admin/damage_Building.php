                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-remove-sign"></i> Damage/Rusak Gedung dan Bangunan</div>
                          <div class="muted pull-right">
								Total: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
				<h4 id="sc">Daftar Gedung dan Bangunan Rusak
 ...
 <br/>
	<div class="pull-left">
			...
			<?php	
               ...
               ?>
				<li class="">
				<a href="damage_heavy_equipment.php">Alat Berat<span class="label label-default"> <?php echo $count;?></span></a></a>
				</li>
			 ...
			 <?php	
               ...
               ?>
				<li class="">
				<a href="damage_transport_equipment.php">Alat Angkutan<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
			 ...
			 <?php	
               ...
               ?>
				<li class="">
				<a href="damage_WorkshopTool.php">Alat Bengkel dan Alat Ukur&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
								
			 <?php	
	           $count_item=mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Damage/Rusak' and dev_name = 'Alat Kantor dan Rumah Tangga' ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
               ?>
				<li class="">
				<a href="damage_OfficeTool.php">Alat Kantor dan Rumah Tangga&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
               ...
               ?>
				<li class="">
				<a href="damage_StudioTool.php">Alat Studio dan Komunikasi<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
               ...
               ?>
				<li class="active">
				<a href="damage_Building.php">Gedung dan Bangunan&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
               ...
               ?>
				<li class="">
				<a href="damage_Installation.php">INSTALASI&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
...
<?php
		...
		<td class="empty">
			...
			<td><a rel="tooltip" title="Repair" id="e<?php echo $id; ?>" href="#repair<?php echo $id; ?>" data-toggle="modal" class="btn btn-success"><div class="hide">Damage/Rusak</div>Repair</a></td>
			<?php }else{ ?>
			<td></td>
			<?php } ?>									
