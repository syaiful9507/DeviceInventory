<div class="row-fluid">				  
   <a href="dev_name.php" class="btn btn-info" id="add" data-placement="right" title="Click untuk menambah" ><i class="icon-plus-sign icon-large"></i> Tambah</a>
	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-pencil icon-large"></i> Edit Jenis barang</div>
                            </div>
								...
								<form method="post">
										<div class="control-group">
                                          <div class="controls">
											...
											<div class="control-group">
                                          <div class="controls">
												<button name="update" class="btn btn-success" id="update" data-placement="right" title="Click untuk update"><i class="icon-save icon-large"> Update</i></button>
                                                <script type="text/javascript">
	                                            $(document).ready(function(){
	                                            $('#update').tooltip('show');
	                                            $('#update').tooltip('hide');
...
<script>
 ...
 $.jGrowl("Jenis barang sukses di update", { header: 'Device Name Update' });
</script>
<?php
}
?>