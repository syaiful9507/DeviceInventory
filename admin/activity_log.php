            ...
            <div class="row-fluid">
                ...
                <div class="empty">
                    <div class="alert alert-success alert-dismissable">
                        ...
                        <i class="icon-info-sign"></i> <strong>Note!:</strong> tandai jika anda ingin menghapus?
                    </div>
                </div>
                        ...
                        <div class="span12">
                            <form action="delete_log.php" method="post">
                                <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                    <a data-placement="right" title="klik disini untuk menghapus yang ditandai" data-toggle="modal"
                                       href="#delete_log" id="delete" class="btn btn-danger" name=""><i
                                                class="icon-trash icon-large"> Delete</i></a>
