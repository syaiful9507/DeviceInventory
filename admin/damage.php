            ...
            <div class="row-fluid">
                ...
                <div id="block_bg" class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left"><i class="icon-remove-sign"></i> Daftar stok barang rusak</div>
                        <div class="muted pull-right">
                            Total Barang Rusak: <span class="badge badge-info"><?php echo $count; ?></span>
                        </div>
                    </div>

                    <h4 id="sc">Daftar stok barang rusak
			   ...
			   where 
			      ...
			      ORDER BY stdevice.id DESC");
                                    ...
                                    $count_item = mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Damage/Rusak' and dev_name = 'Alat Angkutan' ORDER BY stdevice.id DESC");
                                    $count = mysql_num_rows($count_item);
                                    ?>
                                    <li class="">
                        ...
                        <div class="row-fluid">
                            <div class="empty">
                                <div class="pull-right">
                                    <a href="print_damage.php" class="btn btn-info" id="print" data-placement="left"
