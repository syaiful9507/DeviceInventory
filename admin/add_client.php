        ...
        <div class="block-content collapse in">
            <div class="span12">
                ...
                <form method="post">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <input type="password" class="input focused" name="password" id="focusedInput" type="text"
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <button name="save" class="btn btn-info" id="save" data-placement="right"
                                    title="Click to Save"><i class="icon-plus-sign icon-large"> Save</i></button>
...
if (isset($_POST['save'])) {
    ...
    if ($count > 0) { ?>
        ...
        mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','menambahkan user client $firstname')") or die(mysql_error());
        ?>
        <script>
            window.location = "client_user.php";
            $.jGrowl("Sukses di tambahkan", {header: 'Client User add'});
        </script>
        <?php
    }
}
