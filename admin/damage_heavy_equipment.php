...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="span9" id="content">
            <div class="row-fluid">
                ...
                $count_item = mysql_query("select * from stdevice 
				 ...
				 where 
			      dev_status = 'Damage/Rusak'    and dev_name = 'Alat Berat'ORDER BY stdevice.id DESC");
                $count = mysql_num_rows($count_item);
                ?>
                <div id="block_bg" class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left"><i class="icon-remove-sign"></i> Damage/Rusak Tool (s) List</div>
                        <div class="muted pull-right">
                            total: <span class="badge badge-info"><?php echo $count; ?></span>
                        </div>
                    </div>

                    <h4 id="sc">Daftar Alat Berat Rusak
		...
		LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
		where 
			      dev_status = 'Damage/Rusak'    and dev_name = 'Alat Berat'ORDER BY stdevice.id DESC") or die(mysql_error());
