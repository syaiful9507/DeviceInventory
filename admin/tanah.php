        ...
        <div class="span9" id="content">
            <div class="row-fluid">
			   ...
			   ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="monitor.php">Monitor&nbsp;<span
			   ...
			   ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="power_supply.php">Power Supply&nbsp;<span
                                                    class="label label-default"> <?php echo $count; ?></span></a>
                                    </li>
			   ...
			   ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="power_cords.php">Power Cord&nbsp;<span
                                                    class="label label-default"> <?php echo $count; ?></span></a>
                                    </li>
