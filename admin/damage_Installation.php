            ...
            <div class="row-fluid">
                ...
                <div id="block_bg" class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left"><i class="icon-remove-sign"></i> Damage/Rusak INSTALASI
                        </div>
                    ...
                    <h4 id="sc">Daftar INSTALASI Rusak
			   ...
			   where dev_status = 'Damage/Rusak' and dev_name = 'Gedung dan Bangunan'
			    ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="damage_OfficeTool.php">Gedung dan Bangunan<span
                                                    class="label label-default"> <?php echo $count; ?></span></a>
                                    </li>
                        ...
                        <div class="row-fluid">
                            <div class="empty">
                                <div class="pull-right">
                                    <a href="#" onclick="window.print()" class="btn btn-info" id="print"
                                       data-placement="left" title="Click to Print"><i
