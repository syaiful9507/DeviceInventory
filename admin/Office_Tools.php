        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="span9" id="content">
                     <div class="row-fluid">
					 <a href="add_Device.php" class="btn btn-info"  id="add" data-placement="right" title="Click to Tambah Barang" ><i class="icon-plus-sign icon-large"></i> Tambah Barang</a>
				...
				<h4 id="sc">Daftar Alat Kantor dan Rumah Tangga
...
<!-----------------------------------Content------------------------------------>
		...
		LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
		where dev_name = 'Alat Kantor dan Rumah Tangga' ORDER BY stdevice.id DESC") or die(mysql_error());
