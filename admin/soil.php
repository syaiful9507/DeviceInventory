        ...
        <div class="span9" id="content">
            <div class="row-fluid">
                <a href="add_Device.php" class="btn btn-info" id="add" data-placement="right"
                   title="Click to Add Device"><i class="icon-plus-sign icon-large"></i> Tambah Barang</a>
			   ...
			   ORDER BY stdevice.id DESC");
                ...
                <div id="block_bg" class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Daftar tanah</div>
                        <div class="muted pull-right">
                            Total tanah: <span class="badge badge-info"><?php echo $count; ?></span>
                        </div>
                    </div>

                    <h4 id="sc">Daftar tanah
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="pull-left">
                                <ul class="nav nav-pills">
                                    ...
                                    $count_item = mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_name = 'tanah' OR dev_name = 'Tanah' OR dev_name = 'TANAH'
			   OR dev_name = 'tnah' OR dev_name = 'nah' OR dev_name = 'thna' OR dev_name = 'hanat'OR dev_name = 'tnh' OR dev_name = '(tanah)'
			   OR dev_name = '(tnh)'
			   ORDER BY stdevice.id DESC");
                                    $count = mysql_num_rows($count_item);
                                    ?>
                                    <li class="active">
                                        <a href="tanah.php.php">tanah&nbsp;<span
			   ...
			   where dev_name = 'Alat Berat' ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="heavy_equipment.php">Alat Berat&nbsp;<span
			   ...
			   where dev_name = 'Alat Angkutan' ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="Transport_equipment.php">Alat Angkutan&nbsp;<span
                                                    class="label label-default"> <?php echo $count; ?></span></a></a></a>
                                    </li>
			   ...
			   where dev_name = 'Alat Bengkel dan Alat Ukur' ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="WorkshopTool.php">Alat Bengkel dan Alat Ukur&nbsp;<span
                                                    class="label label-default"> <?php echo $count; ?></span></a>
                                    </li>
			   ...
			   where dev_name = 'Alat Kantor dan Rumah Tangga' ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="Office_Tools.php">Alat Kantor dan Rumah Tangga&nbsp;<span
                                                    class="label label-default"> <?php echo $count; ?></span></a>
                                    </li>
			   ...
			   where dev_name = 'Alat Studio dan Komunikasi' ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="StudioTool.php">Alat Studio dan Komunikasi&nbsp;<span
                                                    class="label label-default"> <?php echo $count; ?></span></a>
                                    </li>
			   ...
			   where dev_name = 'Gedung dan Bangunan' ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="building.php">Gedung dan Bangunan&nbsp;<span
                                                    class="label label-default"> <?php echo $count; ?></span></a>
                                    </li>
			   ...
			   where dev_name = 'INSTALASI' ORDER BY stdevice.id DESC");
                                    ...
                                    ?>
                                    <li class="">
                                        <a href="Installation.php">INSTALASI&nbsp;<span
                                                    class="label label-default"> <?php echo $count; ?></span></a>
                                    </li>
			   ...
			   ORDER BY stdevice.id DESC") or die(mysql_error());
                                    while ($row = mysql_fetch_array($device_query)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="empty" width="80"><a rel="tooltip" title="Edit Device"
                                                                            id="e<?php echo $id; ?>"
                                                                            href="device_edit.php<?php echo '?id=' . $id; ?>"
                                                                            class="btn btn-success"><i
                                                            class="icon-pencil"> Edit</i> </a></td>
                                        </tr>
