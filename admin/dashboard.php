            ...
            <div class="row-fluid">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-success alert-dismissable">
                        ...
                        <img id="avatar1" class="img-circle" src="<?php echo $row['adminthumbnails']; ?>"><strong>
                            Welcome! <?php echo $user_row['firstname'] . " " . $user_row['lastname']; ?></strong>
                    </div>
                </div>
