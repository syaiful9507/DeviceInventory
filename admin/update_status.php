		                        ...
		                        <div id="" class="block">
									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword"  placeholder="Status Barang" >Status Barang</label>
											<div class="controls">
										...
										mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Update Status $dev_name ke $dev_status')")or die(mysql_error());
										?>
										<script>
