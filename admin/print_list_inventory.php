        ...
        <div class="row-fluid">
            <div class="col-lg-12">
                <div class="alert alert-success alert-dismissable">
                    ...
                    <i class="icon-building"></i><strong>&nbsp;<?php echo $location_row['stdev_location_name']; ?>&nbsp;Print
                        Report</strong>
                </div>
            </div>
        </div>
...
font-family:"Times New Roman","serif"'><img width=356 height=130 id="Picture 1"
                    ...
                    <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
text-align:center;line-height:normal'><b><span style='font-size:14.0pt;
font-family:"Times New Roman","serif"'>LAPORAN BARANG</span></b></p>

                    <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
text-align:center;line-height:normal'><b><span style='font-size:8.0pt;
font-family:"Times New Roman","serif"'>Powered by Kominfo 2017</span></b></p>
...
"Times New Roman","serif"'>Lokasi:&nbsp;<?php echo $location_row['stdev_location_name']; ?>
                                            <o:p></o:p></span></p>
...
"Times New Roman","serif"'>DATE: <?php
           ...
           "Times New Roman","serif"'>
			<a id="return" data-placement="top" class="btn btn-success" title="Click to Return"
               href="mydevice.php<?php echo '?stdev_id=' . $get_id; ?>"><i class="icon-arrow-left"></i> Back</a></p>
                                            <script type="text/javascript">
                                                $(document).ready(function () {
                                                    $('#return').tooltip('show');
                                                    $('#return').tooltip('hide');
...
order by date_deployment DESC") or die(mysql_error());
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
                                                <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif"'><?php echo $row['date_deployment']; ?>
                                                        <o:p></o:p></span></p>
                                            </td>
                                            <td width=188 valign=top style='width:140.95pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
...
"Times New Roman","serif"'><o:p>&nbsp;</o:p></span></p>
 ...
 mso-yfti-tbllook:1184;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
  ...
  "Times New Roman","serif"'><o:p>&nbsp;</o:p></span></p>
			  ...
			  where NOT EXISTS 
             (select * from location_details where dev_status='Dump')
			  and dev_name = 'Tanah'  and stdev_id = '$get_id' ") or die(mysql_error());
...
order by date_deployment DESC") or die(mysql_error());
  ...
  "Times New Roman","serif"'><o:p>&nbsp;</o:p></span></p>
				...
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump') 
			    and dev_name = 'Alat Berat'        and stdev_id = '$get_id'") or die(mysql_error());
...
order by date_deployment DESC") or die(mysql_error());
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
                                                <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
  "Times New Roman","serif"'>Digunakan<o:p></o:p></span></p>
                                            </td>
                                            <td width=192 valign=top style='width:2.0in;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  ...
  "Times New Roman","serif"'><o:p>&nbsp;</o:p></span></p>
				...
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				and dev_name = 'Alat Angkutan'     and stdev_id = '$get_id' ") or die(mysql_error());
...
order by date_deployment DESC") or die(mysql_error());
  ...
  "Times New Roman","serif"'><o:p>&nbsp;</o:p></span></p>
				...
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump') 
			    and dev_name = 'Alat Bengkel dan Alat Ukur'   and stdev_id = '$get_id' ") or die(mysql_error());
...
LEFT JOIN stdevice ON location_details.id = stdevice.id 
LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
where dev_status = 'Damage/Rusak' and stdev_id = '$get_id'		
order by date_deployment DESC") or die(mysql_error());
                                            $count = mysql_num_rows($new);
                                            ?>
  ...
  "Times New Roman","serif"'><o:p>&nbsp;</o:p></span></p>
				...
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				and dev_name = 'Alat Kantor dan Rumah Tangga'      and stdev_id = '$get_id' ") or die(mysql_error());
  ...
  "Times New Roman","serif"'><?php echo $count; ?>
				...
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump')
			    and dev_name = 'Alat Studio dan Komunikasi'   and stdev_id = '$get_id'") or die(mysql_error());
  ...
  "Times New Roman","serif"'><?php echo $count; ?>
				...
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump') 
			    and dev_name = 'Gedung dan Bangunan'       and stdev_id = '$get_id'") or die(mysql_error());
                                        $count = mysql_num_rows($my_vga);
                                        ?>
                                        <tr style='mso-yfti-irow:4;mso-yfti-lastrow:yes'>
                                            <td width=60 valign=top style='width:44.75pt;border:none;border-right:solid windowtext 1.0pt;
  ...
  "Times New Roman","serif"'><?php echo $count; ?>
				...
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				 and dev_name = 'INSTALASI'  ") or die(mysql_error());
