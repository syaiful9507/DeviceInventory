 ...
 <br/>
	<div class="pull-left">
			  ...
			  <?php	
               ...
               ?>
				<li class="">
				<a href="heavy_equipment.php">Alat Berat&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
...
<!-----------------------------------Content------------------------------------>
		...
		LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
		where dev_name = 'Alat Angkutan' ORDER BY stdevice.id DESC") or die(mysql_error());
